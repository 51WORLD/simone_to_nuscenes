...
def generate_sequences(input_file, output_folder):
    ...
    for item in data:
        ...
        if instance_token in sequences:
            continue
        elif instance_token not in sequences:
            sequences[instance_token] = []
        ...
        while current_item:
            ...
            if current_item['next'] == " ":
                break
            current_item = token_dict.get(current_item['next'], None)
...
def main():
    ...
    for instance_token, sequence in sequences.items():
        ...
        # 拿 instance token 到 data/instances.json 获取 type
        ...
        if type in utils.simone2nuscenes_lst:
            ...
            first_annotation_token = 1
            last_annotation_token = 1
